...
class DTWLoss(nn.Module):
    ...
    def forward(self, input, target):
        ...
        loss = soft_dtw_loss(input, target).mean()
        return loss
...
loss_fn = DTWLoss()  # Regression loss
...
df.to_csv('transformer_adam_lr001_epstein_loss_no_pmax_dtw.csv', index=False)
torch.save(model.state_dict(), "transformer_adam_lr001_epstein_no_pmax_dtw.pth")
...
df = pd.DataFrame(loss, columns=["loss"])
df.to_csv('transformer_adam_lr01_epstein_loss_no_pmax_dtw.csv', index=False)
torch.save(model.state_dict(), "transformer_adam_lr01_epstein_no_pmax_dtw.pth")
...
df = pd.DataFrame(loss, columns=["loss"])
df.to_csv('transformer_adam_lr0001_epstein_loss_no_pmax_dtw.csv', index=False)
torch.save(model.state_dict(), "transformer_adam_lr0001_epstein_no_pmax_dtw.pth")
...
df = pd.DataFrame(loss, columns=["loss"])
df.to_csv('transformer_adamW_lr001_epstein_loss_no_pmax_dtw.csv', index=False)
torch.save(model.state_dict(), "transformer_adamW_lr001_epstein_no_pmax_dtw.pth")
...
df = pd.DataFrame(loss, columns=["loss"])
df.to_csv('transformer_adamW_lr01_epstein_loss_no_pmax_dtw.csv', index=False)
torch.save(model.state_dict(), "transformer_adamW_lr01_epstein_no_pmax_dtw.pth")
...
df = pd.DataFrame(loss, columns=["loss"])
df.to_csv('transformer_adamW_lr0001_epstein_loss_no_pmax_dtw.csv', index=False)
torch.save(model.state_dict(), "transformer_adamW_lr0001_epstein_no_pmax_dtw.pth")
