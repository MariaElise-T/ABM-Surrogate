...
valid_data.to_csv("validation_set_br.csv", index=False)
...
df.to_csv('transformer_adam_lr001_br_loss.csv', index=False)
torch.save(model.state_dict(), "transformer_adam_lr001_br.pth")
...
df = pd.DataFrame(loss, columns=["loss"])
df.to_csv('transformer_adam_lr01_br_loss.csv', index=False)
torch.save(model.state_dict(), "transformer_adam_lr01_br.pth")
...
df = pd.DataFrame(loss, columns=["loss"])
df.to_csv('transformer_adam_lr0001_br_loss.csv', index=False)
torch.save(model.state_dict(), "transformer_adam_lr0001_br.pth")
...
df = pd.DataFrame(loss, columns=["loss"])
df.to_csv('transformer_adamW_lr001_br_loss.csv', index=False)
torch.save(model.state_dict(), "transformer_adamW_lr001_br.pth")
...
df = pd.DataFrame(loss, columns=["loss"])
df.to_csv('transformer_adamW_lr01_br_loss.csv', index=False)
torch.save(model.state_dict(), "transformer_adamW_lr01_br.pth")
...
df = pd.DataFrame(loss, columns=["loss"])
df.to_csv('transformer_adamW_lr0001_br_loss.csv', index=False)
torch.save(model.state_dict(), "transformer_adamW_lr0001_br.pth")
